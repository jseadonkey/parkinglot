# Zoning sources - Kitsap County, WA
...
Parcels in **Kitsap County (`53035`)** must be assigned to the zoning authority that controls the parcel:

- **`kitsap_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Kitsap County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `kitsap_unincorporated` | Kitsap County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Kitsap County zoning/use table - TODO
...
|--------------|------|------------|---------------------|-------|
| `bremerton_city` | Bremerton | TBD - official city zoning GIS/service | Bremerton zoning/use table - TODO | Identify city GIS and ordinance use table. |
