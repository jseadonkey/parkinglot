# Zoning sources - San Juan County, WA
...
Parcels in **San Juan County (`53055`)** must be assigned to the zoning authority that controls the parcel:

- **`san_juan_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | San Juan County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `san_juan_unincorporated` | San Juan County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- San Juan County zoning/use table - TODO
...
- `docs/zoning-sources-san-juan.md`
