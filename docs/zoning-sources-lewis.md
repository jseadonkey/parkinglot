# Zoning sources - Lewis County, WA
...
Parcels in **Lewis County (`53041`)** must be assigned to the zoning authority that controls the parcel:

- **`lewis_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Lewis County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `lewis_unincorporated` | Lewis County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Lewis County zoning/use table - TODO
