# Zoning sources - Skagit County, WA
...
Parcels in **Skagit County (`53057`)** must be assigned to the zoning authority that controls the parcel:

- **`skagit_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Skagit County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `skagit_unincorporated` | Skagit County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Skagit County zoning/use table - TODO
