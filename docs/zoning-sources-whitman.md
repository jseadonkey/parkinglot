# Zoning sources - Whitman County, WA
...
Parcels in **Whitman County (`53075`)** must be assigned to the zoning authority that controls the parcel:

- **`whitman_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Whitman County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `whitman_unincorporated` | Whitman County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Whitman County zoning/use table - TODO
...
- `docs/zoning-sources-whitman.md`
