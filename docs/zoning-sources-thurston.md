# Zoning sources - Thurston County, WA
...
Parcels in **Thurston County (`53067`)** must be assigned to the zoning authority that controls the parcel:

- **`thurston_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Thurston County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `thurston_unincorporated` | Thurston County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Thurston County zoning/use table - TODO
...
|--------------|------|------------|---------------------|-------|
| `olympia_city` | Olympia | TBD - official city zoning GIS/service | Olympia zoning/use table - TODO | Identify city GIS and ordinance use table. |
| `lacey_city` | Lacey | TBD - official city zoning GIS/service | Lacey zoning/use table - TODO | Identify city GIS and ordinance use table. |
...
- `docs/zoning-sources-thurston.md`
