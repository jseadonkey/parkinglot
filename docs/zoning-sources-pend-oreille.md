# Zoning sources - Pend Oreille County, WA
...
Parcels in **Pend Oreille County (`53051`)** must be assigned to the zoning authority that controls the parcel:

- **`pend_oreille_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Pend Oreille County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `pend_oreille_unincorporated` | Pend Oreille County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Pend Oreille County zoning/use table - TODO
...
- `docs/zoning-sources-pend-oreille.md`
