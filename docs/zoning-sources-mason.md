# Zoning sources - Mason County, WA
...
Parcels in **Mason County (`53045`)** must be assigned to the zoning authority that controls the parcel:

- **`mason_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Mason County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `mason_unincorporated` | Mason County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Mason County zoning/use table - TODO
