# Zoning sources - Garfield County, WA
...
Parcels in **Garfield County (`53023`)** must be assigned to the zoning authority that controls the parcel:

- **`garfield_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Garfield County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `garfield_unincorporated` | Garfield County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Garfield County zoning/use table - TODO
...
- `docs/zoning-sources-garfield.md`
