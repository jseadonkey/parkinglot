# Zoning sources - Cowlitz County, WA
...
Parcels in **Cowlitz County (`53015`)** must be assigned to the zoning authority that controls the parcel:

- **`cowlitz_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Cowlitz County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `cowlitz_unincorporated` | Cowlitz County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Cowlitz County zoning/use table - TODO
...
- `docs/zoning-sources-cowlitz.md`
