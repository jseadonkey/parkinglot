# Zoning sources - Klickitat County, WA
...
Parcels in **Klickitat County (`53039`)** must be assigned to the zoning authority that controls the parcel:

- **`klickitat_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Klickitat County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `klickitat_unincorporated` | Klickitat County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Klickitat County zoning/use table - TODO
...
- `docs/zoning-sources-klickitat.md`
