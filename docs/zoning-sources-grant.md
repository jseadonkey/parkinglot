# Zoning sources - Grant County, WA
...
Parcels in **Grant County (`53025`)** must be assigned to the zoning authority that controls the parcel:

- **`grant_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Grant County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `grant_unincorporated` | Grant County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Grant County zoning/use table - TODO
