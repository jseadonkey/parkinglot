# Zoning sources - Whatcom County, WA
...
Parcels in **Whatcom County (`53073`)** must be assigned to the zoning authority that controls the parcel:

- **`whatcom_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Whatcom County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `whatcom_unincorporated` | Whatcom County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Whatcom County zoning/use table - TODO
...
|--------------|------|------------|---------------------|-------|
| `bellingham_city` | Bellingham | TBD - official city zoning GIS/service | Bellingham zoning/use table - TODO | Identify city GIS and ordinance use table. |
...
- `docs/zoning-sources-whatcom.md`
