# Zoning sources - Spokane County, WA
...
Parcels in **Spokane County (`53063`)** must be assigned to the zoning authority that controls the parcel:

- **`spokane_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Spokane County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `spokane_unincorporated` | Spokane County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Spokane County zoning/use table - TODO
...
|--------------|------|------------|---------------------|-------|
| `spokane_city` | Spokane | TBD - official city zoning GIS/service | Spokane zoning/use table - TODO | Identify city GIS and ordinance use table. |
...
- `docs/zoning-sources-spokane.md`
