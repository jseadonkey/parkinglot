# Zoning sources - Franklin County, WA
...
Parcels in **Franklin County (`53021`)** must be assigned to the zoning authority that controls the parcel:

- **`franklin_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Franklin County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `franklin_unincorporated` | Franklin County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Franklin County zoning/use table - TODO
...
- `docs/zoning-sources-franklin.md`
