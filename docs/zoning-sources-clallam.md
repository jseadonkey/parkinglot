# Zoning sources - Clallam County, WA
...
Parcels in **Clallam County (`53009`)** must be assigned to the zoning authority that controls the parcel:

- **`clallam_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Clallam County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `clallam_unincorporated` | Clallam County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Clallam County zoning/use table - TODO
...
- `docs/zoning-sources-clallam.md`
