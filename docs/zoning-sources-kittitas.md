# Zoning sources - Kittitas County, WA
...
Parcels in **Kittitas County (`53037`)** must be assigned to the zoning authority that controls the parcel:

- **`kittitas_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Kittitas County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `kittitas_unincorporated` | Kittitas County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Kittitas County zoning/use table - TODO
...
- `docs/zoning-sources-kittitas.md`
