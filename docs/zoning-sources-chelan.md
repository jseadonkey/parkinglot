# Zoning sources - Chelan County, WA
...
Parcels in **Chelan County (`53007`)** must be assigned to the zoning authority that controls the parcel:

- **`chelan_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Chelan County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `chelan_unincorporated` | Chelan County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Chelan County zoning/use table - TODO
