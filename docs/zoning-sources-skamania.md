# Zoning sources - Skamania County, WA
...
Parcels in **Skamania County (`53059`)** must be assigned to the zoning authority that controls the parcel:

- **`skamania_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Skamania County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `skamania_unincorporated` | Skamania County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Skamania County zoning/use table - TODO
...
- `docs/zoning-sources-skamania.md`
