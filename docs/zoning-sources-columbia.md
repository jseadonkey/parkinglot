# Zoning sources - Columbia County, WA
...
Parcels in **Columbia County (`53013`)** must be assigned to the zoning authority that controls the parcel:

- **`columbia_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Columbia County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `columbia_unincorporated` | Columbia County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Columbia County zoning/use table - TODO
...
- `docs/zoning-sources-columbia.md`
