# Zoning sources - Stevens County, WA
...
Parcels in **Stevens County (`53065`)** must be assigned to the zoning authority that controls the parcel:

- **`stevens_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Stevens County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `stevens_unincorporated` | Stevens County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Stevens County zoning/use table - TODO
...
- `docs/zoning-sources-stevens.md`
