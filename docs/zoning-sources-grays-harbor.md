# Zoning sources - Grays Harbor County, WA
...
Parcels in **Grays Harbor County (`53027`)** must be assigned to the zoning authority that controls the parcel:

- **`grays_harbor_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Grays Harbor County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `grays_harbor_unincorporated` | Grays Harbor County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Grays Harbor County zoning/use table - TODO
...
- `docs/zoning-sources-grays-harbor.md`
