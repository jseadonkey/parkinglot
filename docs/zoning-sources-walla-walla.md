# Zoning sources - Walla Walla County, WA
...
Parcels in **Walla Walla County (`53071`)** must be assigned to the zoning authority that controls the parcel:

- **`walla_walla_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Walla Walla County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `walla_walla_unincorporated` | Walla Walla County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Walla Walla County zoning/use table - TODO
...
- `docs/zoning-sources-walla-walla.md`
