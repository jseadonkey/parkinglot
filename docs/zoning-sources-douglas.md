# Zoning sources - Douglas County, WA
...
Parcels in **Douglas County (`53017`)** must be assigned to the zoning authority that controls the parcel:

- **`douglas_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Douglas County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `douglas_unincorporated` | Douglas County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Douglas County zoning/use table - TODO
...
- `docs/zoning-sources-douglas.md`
