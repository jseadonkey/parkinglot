# Zoning sources - Ferry County, WA
...
Parcels in **Ferry County (`53019`)** must be assigned to the zoning authority that controls the parcel:

- **`ferry_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Ferry County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `ferry_unincorporated` | Ferry County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Ferry County zoning/use table - TODO
