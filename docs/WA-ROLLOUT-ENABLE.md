...
- Wait after each county ≈ **0.1 days + 0.005 × (parcels ÷ 10,000)**, capped at **0.5 days**
- Small county (~5k parcels) → ~0.1 days before the next
- Large county (~120k parcels) → ~0.16 days
