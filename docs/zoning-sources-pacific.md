# Zoning sources - Pacific County, WA
...
Parcels in **Pacific County (`53049`)** must be assigned to the zoning authority that controls the parcel:

- **`pacific_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Pacific County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `pacific_unincorporated` | Pacific County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Pacific County zoning/use table - TODO
...
- `docs/zoning-sources-pacific.md`
