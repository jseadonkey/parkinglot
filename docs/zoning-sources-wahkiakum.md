# Zoning sources - Wahkiakum County, WA
...
Parcels in **Wahkiakum County (`53069`)** must be assigned to the zoning authority that controls the parcel:

- **`wahkiakum_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Wahkiakum County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `wahkiakum_unincorporated` | Wahkiakum County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Wahkiakum County zoning/use table - TODO
...
- `docs/zoning-sources-wahkiakum.md`
