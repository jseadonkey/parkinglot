# Zoning sources - Pierce County, WA
...
Parcels in **Pierce County (`53053`)** must be assigned to the zoning authority that controls the parcel:

- **`pierce_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Pierce County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `pierce_unincorporated` | Pierce County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Pierce County zoning/use table - TODO
...
|--------------|------|------------|---------------------|-------|
| `tacoma_city` | Tacoma | TBD - official city zoning GIS/service | Tacoma zoning/use table - TODO | Identify city GIS and ordinance use table. |
| `lakewood_city` | Lakewood | TBD - official city zoning GIS/service | Lakewood zoning/use table - TODO | Identify city GIS and ordinance use table. |
| `puyallup_city` | Puyallup | TBD - official city zoning GIS/service | Puyallup zoning/use table - TODO | Identify city GIS and ordinance use table. |
