# Zoning sources - Jefferson County, WA
...
Parcels in **Jefferson County (`53031`)** must be assigned to the zoning authority that controls the parcel:

- **`jefferson_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Jefferson County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `jefferson_unincorporated` | Jefferson County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Jefferson County zoning/use table - TODO
...
- `docs/zoning-sources-jefferson.md`
