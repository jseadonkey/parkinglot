...
- **Data quality & jurisdiction parity** — county/city coverage gaps, stale 24h/7d unresolved data issues, and recommended fixes from **`GET /internal/stats/jurisdiction-quality`**.
