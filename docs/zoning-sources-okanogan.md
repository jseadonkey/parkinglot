# Zoning sources - Okanogan County, WA
...
Parcels in **Okanogan County (`53047`)** must be assigned to the zoning authority that controls the parcel:

- **`okanogan_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Okanogan County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `okanogan_unincorporated` | Okanogan County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Okanogan County zoning/use table - TODO
...
- `docs/zoning-sources-okanogan.md`
