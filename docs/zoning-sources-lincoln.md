# Zoning sources - Lincoln County, WA
...
Parcels in **Lincoln County (`53043`)** must be assigned to the zoning authority that controls the parcel:

- **`lincoln_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Lincoln County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `lincoln_unincorporated` | Lincoln County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Lincoln County zoning/use table - TODO
...
- `docs/zoning-sources-lincoln.md`
