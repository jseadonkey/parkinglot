# Zoning sources - Benton County, WA
...
Parcels in **Benton County (`53005`)** must be assigned to the zoning authority that controls the parcel:

- **`benton_unincorporated`** for unincorporated county zoning.
...
| County assessor/value/address enrichment | Benton County assessor roll | TBD - official county assessor/parcel roll | APN;PARCEL_ID_NR;PIN; situs: TBD; mailing: TBD | not_started |

## Unincorporated county zoning source

| Jurisdiction | Source | URL | Zone fields | Status |
|--------------|--------|-----|-------------|--------|
| `benton_unincorporated` | Benton County unincorporated zoning | TBD - official county zoning GIS/service | TBD | not_started |

Ordinance/use-table references to curate before trusting scores:

- Benton County zoning/use table - TODO
